...
VALUES
  ...
  ('BAT-SRNE-002', 'Battery', 'SRNE LiFePO4 Wall Mount 2.56kWh/24V',
  ...
  ('BAT-SRNE-003', 'Battery', 'SRNE LiFePO4 Rack Mount 5.12kWh/48V',
  ...
  ('BAT-SRNE-004', 'Battery', 'SRNE LiFePO4 Wall Mount 5.12kWh/48V (SE05B)',
   '51.2V / 100Ah / 5.12kWh — SE05B', 'pc', 3059000, 3671000, 'SUP-007',
   'Wall mount. 6,000 cycles at 80% DoD. Max parallel: 16. WiFi/BT monitoring.',
   '{"ah": 100, "voltage": 51.2, "dod_rated": 0.8, "chemistry": "LiFePO4", "is_complete_bank": true, "max_parallel": 16}'::jsonb),

  ('BAT-SRNE-005', 'Battery', 'SRNE LiFePO4 Wall Mount 10.49kWh/48V (SE10B)',
  ...
  ('BAT-SRNE-006', 'Battery', 'SRNE LiFePO4 Wall Mount 16.07kWh/48V (SE16B-Pro)',
  ...
  ('BAT-SRNE-007', 'Battery', 'SRNE LiFePO4 Expansion Pack 5.12kWh/48V (EOV05B)',
...
-- ── SRNE Inverter-Chargers ────────────────────────────────────────────────────
INSERT INTO catalog_items (id, category, name, spec, uom, buy_price, sell_price, supplier_id, notes, spec_data)
VALUES
  ('INV-SRNE-001', 'Inverter', 'SRNE Solar Inverter 1.5kW/12V MPPT',
  ...
  ('INV-SRNE-002', 'Inverter', 'SRNE Solar Inverter 3kW/24V MPPT',
  ...
  ('INV-SRNE-003', 'Inverter', 'SRNE Solar Inverter 3.3kW/24V MPPT HV',
  ...
  ('INV-SRNE-004', 'Inverter', 'SRNE Solar Inverter 5kW/48V MPPT (Parallel)',
  ...
  ('INV-SRNE-005', 'Inverter', 'SRNE Solar Inverter 6kW/48V Dual MPPT (Parallel)',
  ...
  ('INV-SRNE-006', 'Inverter', 'SRNE Hybrid Inverter 6kW/48V WiFi (Parallel)',
  ...
  ('INV-SRNE-007', 'Inverter', 'SRNE Grid/Off-Grid Hybrid 6kW/48V (HESP)',
  ...
  ('INV-SRNE-008', 'Inverter', 'SRNE Solar Inverter 10kW/48V Dual MPPT (Parallel)',
  ...
  ('INV-SRNE-009', 'Inverter', 'SRNE Solar Inverter 12kW/48V Dual MPPT (Parallel)',
  ...
  ('INV-SRNE-010', 'Inverter', 'SRNE Solar Inverter 20kW/48V 3-Phase',
  ...
  ('INV-SRNE-011', 'Inverter', 'SRNE Hybrid Inverter 12kW/48V 3-Phase (HESP)',
...
-- ── SRNE MPPT Charge Controllers ──────────────────────────────────────────────
INSERT INTO catalog_items (id, category, name, spec, uom, buy_price, sell_price, supplier_id, notes, spec_data)
VALUES
  ('CHG-SRNE-001', 'Charge Controller', 'SRNE MPPT Controller 20A/12-24V',
  ...
  ('CHG-SRNE-002', 'Charge Controller', 'SRNE MPPT Controller 30A/12-24V',
  ...
  ('CHG-SRNE-003', 'Charge Controller', 'SRNE MPPT Controller 60A/12-24V',
  ...
  ('CHG-SRNE-004', 'Charge Controller', 'SRNE MPPT Controller 60A/12-48V Fan',
  ...
  ('CHG-SRNE-005', 'Charge Controller', 'SRNE MPPT Controller 100A/12-48V HV',
  ...
  ('CHG-SRNE-006', 'Charge Controller', 'SRNE MPPT Controller 100A/12-48V 500V Fan',
...
INSERT INTO catalog_items (id, category, name, spec, uom, buy_price, sell_price, supplier_id, notes, spec_data)
VALUES
  ('SOL-SRNE-001', 'Solar Panel', 'SRNE Monocrystalline Panel 600Wp',
